...
public class Joystick extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener{
    ...
    private void setupDimensions()
    {
       /* centerX = getWidth() / 8;   // Set positioning for X, CURRENTLY at center, MOVE to bottom left.
        ...
        centerX = getWidth() / 12;   // Set positioning for X, CURRENTLY at center, MOVE to bottom left.
        centerY = getHeight() / (float)1.25;  // Set positioning for Y, SurfaceView methods getW, getH
